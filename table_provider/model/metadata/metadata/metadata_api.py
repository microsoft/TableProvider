...
from ..feature_extractor.data_feature_extractor import DataFeatureExtractor
...
class MetadataApi:
    ...
    def embedding(self, table: pd.DataFrame):
        ...
        # See details about old_output of TapasTokenizer in https://huggingface.co/transformers/_modules/transformers/models/tapas/tokenization_tapas.html#TapasTokenizer.__call__
